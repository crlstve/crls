<!DOCTYPE html>
<html lang="es" class="dark scroll-smooth cursor-crosshair">
<head>
    <meta charset="UTF-8">
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NQ3W6XTC"
    ...
    <header class="sticky top-0 z-10 crt">
        <div class="w-full py-4 container mx-auto max-w-6xl">
            <nav class="flex flex-row justify-end md:justify-start relative px-2 xl:px-0">
                    <svg data-contoller="menu" class="z-10 cursor-pointer md:hidden w-10 h-10 aspect-square  sound p-2 backdrop-blur-sm border border-slate-200 dark:border-dark-border dark:bg-dark bg-[rgba(255,255,255,0.1)] flex justify-center" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="23" height="23" viewBox="0,0,260,260">
                ...
                <ul id="nav-menu" aria="menu" class="fixed w-screen md:w-fit md:relative hidden md:flex md:flex-row flex-wrap justify-center items-center gap-3 md:gap-10 px-6 py-16 md:py-3 backdrop-blur-sm border border-slate-200 dark:border-dark-border dark:bg-dark bg-white bg-[rgba(255,255,255,0.1)] duration-500 top-0 left-0 right-0 bottom-0">
                    ...
                    <li><button id="contact" aria="menu item" aria-label="Contacto" class="btn_nav cursor-pointer sound w-full md:w-fit">contacto</button></li>
                    <li class="flex justify-end md:justify-center">
                        <button id="btn_mode" aria="menu item" aria-label="Modo oscuro" class="sound group p-1 aspect-square bg-transparent relative border border-slate-200 hover:border-red hover:dark:border-primary dark:border-dark-border backdrop-blur hover:backdrop-blur-none overflow-hidden cursor-pointer" type="button">
                            <svg class="group-hover:stroke-red group-hover:dark:stroke-primary dark:translate-y-0 group-hover:dark:-translate-y-8 duration-500 -translate-y-8 group-hover:translate-y-0 group-hover:dark" id="moon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-moon"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454l0 .008" /></svg>
                            <svg class="fill-slate-600 group-hover:fill-red dark:fill-white group-hover:dark:fill-primary
